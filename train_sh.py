...
parser.add_argument('--dtw_data', type=str, default='data/SHMetro/graph_sh_cor.pkl', help='cor data path')
...
parser.add_argument('--save', type=str, default='./save/sh/hyper/1001', help='save path')
...
def main(runid):
    ...
    # predefined_e = torch.zeros_like(predefined_e)
    ...
    for i in range(1, args.epochs + 1):
        ...
        if mvalid_loss < minl:
            ...
            torch.save(engine.model.state_dict(),
                       args.save + "exp" + str(args.expid) + "_" + str(runid) + str(args.layers) + '_' + str(
                           args.epochs) + '_' + str(
                           args.d_model) + str(args.label_len) + '_' + str(args.dropout) + '_' + str(
                           args.num_heads) + '_' + str(
